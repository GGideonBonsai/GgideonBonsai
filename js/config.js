// config.js — Конфигурация Gideon Bonsai
// Замените значения на ваши из Supabase → Settings → API

export const SUPABASE_URL = 'https://oyimrrwsbleuhdnhfsub.supabase.co/rest/v1/';
...
// Название приложения
export const APP_NAME = 'Gideon Bonsai';
